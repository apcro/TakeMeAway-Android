package io.takemeaway.takemeaway.libraries;
...
public class SwipeStack extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        if (mCanLayout) {
            Log.d("SwipeStack", "onLayout, changed = " + String.valueOf(changed));
    ...
    private void reorderItems() {
        Log.d("SwipeStack",
                "reorderItems, childcount = " + String.valueOf(getChildCount()) + ", isFirstLayout = " + String.valueOf(mIsFirstLayout)
        );
    ...
    private void removeTopView() {
        Log.d("SwipeStack", "removeTopView");
        if (mTopView != null) {
            removeView(mTopView);
            mTopView = null;
        }
    ...
    public void onSwipeEnd() {
        ...
        Log.d("SwipeStack", "Swipe End");
        mCanLayout = true;
    }

    public void onViewSwipedToLeft() {
        if (mListener != null) mListener.onViewSwipedToLeft(getCurrentPosition());
        Log.d("SwipeStack", "Swipe Left");
        removeTopView();
    }

    public void onViewSwipedToRight() {
        if (mListener != null) mListener.onViewSwipedToRight(getCurrentPosition());
        Log.d("SwipeStack", "Swipe Right");
        removeTopView();
    }

    public void onViewSwipedUp() {
        if (mListener != null) mListener.onViewSwipedUp(getCurrentPosition());
        Log.d("SwipeStack", "Swipe Up");
        removeTopView();
    }

    public void onViewSwipedDown() {
        if (mListener != null) mListener.onViewSwipedDown(getCurrentPosition());
        Log.d("SwipeStack", "Swipe Down");
        removeTopView();
    }

    public void allowLayout() {
        mCanLayout = true;
    }
    ...
    public interface SwipeStackListener {
         ...
         * @param position The position of the view in the adapter currently in use.
         */
        void onViewSwipedUp(int position);

        /**
         * Called when a view has been dismissed to the bottom.
         *
         * @param position The position of the view in the adapter currently in use.
         */
        void onViewSwipedDown(int position);
